...
let print_ty' ty = print_ty Format.std_formatter ty
...
let print_lv' lv = print_lv Format.std_formatter lv
...
let _ = pp_cnstrl @@ PrimOp2("Add", Int 1, Int 1)
...
let _ = pp_cnstrl @@ Lam_("x", PrimOp2("Add_", Code(Int 1), Var "x"))
