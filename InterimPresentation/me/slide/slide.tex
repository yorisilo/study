...
\begin{frame}[fragile]
  ...
  \begin{onlyenv}<1>
    \begin{exampleblock}{多段階let挿入}
      \begin{align*}
        e_2 & = \red{\cResetz} ~~\cLet~x_1=\csp{3}~\cIn \\
            & \phantom{=}~~ \blue{\cResetz} ~~\cLet~x_2=\csp{5}~\cIn \\
            & \phantom{=}~~ \blue{\cShiftz}~k_2~\to~ \red{\cShiftz}~k_1~\to~ \magenta{\cLet~y=t~\cIn} \\
  ...
  \begin{onlyenv}<2>
    \begin{exampleblock}{多段階let挿入}
      \begin{align*}
        e_2 & \too \magenta{\cLet~y=t~\cIn} \\
            & \phantom{\too}~~ \blue{\cResetz} ~~\cLet~x_2=\csp{5}~\cIn \\
            & \phantom{\too}~~ \red{\cResetz} ~~\cLet~x_1=\csp{3}~\cIn \\
    ...
    \begin{columns}
      \begin{column}{0.5\textwidth}%% [横幅] 0.2\textwidth = ページ幅の 20 %
        \begin{align*}
          ...
          &(\cShiftz ~\blue{k} \to ~\cLet~ x = \red{\gamma_1} ~\cIn~ \red{\gamma_2} \\
          &(\cThrow ~\magenta{k} ~\red{\gamma_3}~)))
        \end{align*}
      \end{column}
      ...
      \begin{column}{0.5\textwidth}%% [横幅] 0.2\textwidth = ページ幅の 20 %
        ...
        \begin{align*}
          \blue{k} ~:~ \contT{\codeT{\cdot}{\gamma_0}}{\codeT{\cdot}{\gamma_1}}\\
          \magenta{k} ~:~  \contT{\codeT{\cdot}{\gamma_3}}{\codeT{\cdot}{\gamma_2}}\\
        \end{align*}
      \end{column}
    \end{columns}
  \end{onlyenv}
